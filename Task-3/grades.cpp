...
void displayMenu() {
    cout << CYAN_COLOR << BOLD << "------------------------" << endl;
    cout << "\tMenu" << endl;
    cout << "------------------------" << endl;
    cout << GREEN_COLOR << "1. " << RESET_COLOR << "Add Student Grade" << endl;
    cout << YELLOW_COLOR << "2. " << RESET_COLOR << "Display Highest, Average, and Lowest Grades" << endl;
    cout << YELLOW_COLOR << "3. " << RESET_COLOR << "Edit Student Grades" << endl;
    cout << RED_COLOR << "4. " << RESET_COLOR << "Delete Student Grades" << endl;
    cout << MAGENTA_COLOR << "5. " << RESET_COLOR << "Exit" << endl;
            ...
            case 1: // Add Student Grade
                {
                    ...
                    for (int i = 0; i < numStudents; ++i) {
                        ...
                        cout << YELLOW_COLOR << "Enter the grade for " << name << ": " << RESET_COLOR;
                        cin >> grade;
